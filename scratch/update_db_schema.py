...
try:
    ...
    cursor = conn.cursor()
    print("Connected to Supabase. Redeplying RPC function with CUIT safety...")
    cursor.execute(sql_rpc)
    conn.commit()
    print("Corrected RPC function deployed successfully!")
except Exception as e:
    print("Error deploying database updates:", e)
finally:
    if 'conn' in locals():
        conn.close()
